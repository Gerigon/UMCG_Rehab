/***************************************************************************************
Class copied from http://forum.unity3d.com/threads/any-tips-for-debugging-android.70197/
***************************************************************************************/
...
public class GuiTextDebug : MonoBehaviour {
    ...
    private static string windowText = "testing";
    ...
    void OnGUI() {
        ...
        if (debugIsOn) {
            ...
            GUI.BeginGroup(new Rect(0, 40.0f, Screen.width, 200.0f));
            ...
            if (GUI.Button(new Rect(0 + 80f, 0.0f, 75.0f, 40.0f), "Clear")) {
                windowText = "";
            }
        }
    }
